...
\noindent\textbf{Keywords:} additive manufacturing, build orientation optimization, support minimization, candidate generation, support-flow tensor, 3D printing
